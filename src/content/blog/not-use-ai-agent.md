...
코파일럿이 출시되고 처음엔 nvim에서 [cmp](https://github.com/giuxtaposition/blink-cmp-copilot)의 자동완성 기능으로 사용하다가 llm이 등장하게 되면서 [avante.nvim](https://github.com/yetone/avante.nvim)을 통해 에이전트로 사용 하였다. [mcp](https://github.com/ravitemer/mcphub.nvim)도 등장 이후에 얹어서 사용하다가 [cli](https://github.com/features/copilot/cli?locale=ko-KR)가 나오게 되면서 최근에는 [sidekick.nvim](https://github.com/folke/sidekick.nvim)과 함께 코딩을 하였다.
...
이렇게 사용하다가도 가끔씩 과거가 그리운지 `claude code`를 사용하고 싶다는 마음이 생기긴 하는데(copilot 사용 시 claude의 모델이 가장 효과가 좋았다) 아직 까진 뭐 돈 내고 쓸 정돈 아닌 것 같다.
